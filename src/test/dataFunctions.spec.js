...
describe('pruebas para funcion "filterData"', () => {
  it('retorna data filtrada por option "guardian sistema solar interno"', () => {
    ...
    expect(resultadoFiltrado[1].extraInfo.tipoGuardian.toLowerCase()).toBe(
      optionValueSeleccionado,
    );
    expect(resultadoFiltrado[2].extraInfo.tipoGuardian.toLowerCase()).toBe(
      optionValueSeleccionado,
    );
    expect(resultadoFiltrado[3].extraInfo.tipoGuardian.toLowerCase()).toBe(
      optionValueSeleccionado,
    );
    expect(resultadoFiltrado[4].extraInfo.tipoGuardian.toLowerCase()).toBe(
      optionValueSeleccionado,
    );
  });
});
