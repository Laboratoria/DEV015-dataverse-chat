...
export const renderView = (pathname, props = {}) => {
  ...
  if (rootEl) {
    ...
    console.error("no existe un root para mostrar el contenido");
  }
  ...
  if (routePath && typeof routePath.component === "function") {
    ...
    console.error("la ruta no se encontro o el componente no existe");
  }
